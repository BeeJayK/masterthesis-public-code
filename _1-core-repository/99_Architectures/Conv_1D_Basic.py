...
def train_baseline():
    ...
    # create basic model
    # TODO: bei Zeiten das mal an einem Wochenende out-maxen:
    #       - die custom layer vorziehen
    #       - das ds predicten
    #       - neues ds daraus erstellen
    #       - training auf single-proc in GPU machen
    #       - ...das umgeht die map-calls auf sehr einfache art. macht ein
    #            modell aber nicht erstmal nicht deployable, da die daten-
    #            pipeline gebrochen wird.
    #       - denkbar wäre also auch ein sweep dieses mods & dann die stärkste
    #       - variante re-trainieren ohne vorgezogenes preprocessing. am 
    #         cleansten natürlich ein rework der map calls, dafür aber am Ende
    #         der Thesis (also jetzt) echt keine Zeit mehr
    # ------------------
